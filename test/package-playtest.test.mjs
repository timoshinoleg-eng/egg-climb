...
test('static playtest package contains only browser runtime assets and preserves subpath imports', async () => {
  ...
  for (const file of ['play/kitchen.html', 'play/kitchen-worker.js', 'play/kitchen-view.js', 'play/kitchen-art.js', 'play/egg-art.js', 'play/modes.js', 'play/kitchen.css', 'dist/game/kitchen-run.js', 'dist/render/kitchen-scene.js']) assert.ok(names.includes(file), file)
